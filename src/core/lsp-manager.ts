...
const SERVER_SPECS: LspServerSpec[] = [
  ...
  },
  {
    id: 'json',
    label: 'JSON',
    command: resolve(PACKAGE_ROOT, 'node_modules/.bin/vscode-json-language-server'),
    args: ['--stdio'],
    checkArgs: ['--version'],
    languageId: 'json',
    extensions: ['.json'],
  ...
  },
  {
    id: 'yaml',
    label: 'YAML',
    command: resolve(PACKAGE_ROOT, 'node_modules/.bin/yaml-language-server'),
    args: ['--stdio'],
    checkArgs: ['--version'],
    languageId: 'yaml',
    extensions: ['.yaml', '.yml'],
    rootMarkers: ['.yamllint', '.yaml-language-server.json'],
  },
  {
    id: 'shell',
    label: 'Shell',
    command: resolve(PACKAGE_ROOT, 'node_modules/.bin/bash-language-server'),
    args: ['start'],
    checkArgs: ['--version'],
  ...
  },
  {
    id: 'html',
    label: 'HTML',
    command: resolve(PACKAGE_ROOT, 'node_modules/.bin/vscode-html-language-server'),
    args: ['--stdio'],
    checkArgs: ['--version'],
    languageId: 'html',
    extensions: ['.html', '.htm'],
  ...
  },
  {
    id: 'css',
    label: 'CSS',
    command: resolve(PACKAGE_ROOT, 'node_modules/.bin/vscode-css-language-server'),
    args: ['--stdio'],
    checkArgs: ['--version'],
    languageId: 'css',
